...
Installation
    ...
    git clone https://github.com/your-username/classroom-reservation.gitcd classroom-reservation
...
🛠️ Tech Stack
     ...
     External APIs: 
         Open-Meteo (Weather widget for Totem)
         Nager.Date (Public Holiday API import)
